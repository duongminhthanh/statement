import { User2Service } from './../../../../core/services/module/user2.service';
...
@Component({
  selector: 'app-user-demo2-modal',
  templateUrl: './user-demo2-modal.component.html',
  styleUrls: ['./user-demo2-modal.component.scss']
})
export class UserDemo2ModalComponent implements OnInit {
  @Input() title: any;
  @Input() item: any;
  ...
  create(formValue) {
      ...
      this.user2Service.createUserDemo(formValue).subscribe(res => {
          if (res.errorCode === '0') {
  ...
  update(formValue) {
      this.loading = true;
      this.user2Service.updateUserDemo(formValue).subscribe(res => {
          if (res.errorCode === '0') {
